...
public final class SqlPipelineCliMain {
  ...
  private static void launchRunApplication(SqlPipelineCliOptions cliOptions) {
    try {
      ...
      throw new IllegalStateException(
        "Spark runtime classes are not available. Use spark-submit, the spark-sdp.sh script, or run the main method from an IDE with Spark dependencies.",
        e);
  ...
  static void printUsage() {
    ...
    System.out.println("  bin/spark-sdp.sh [spark-submit options] run [--spec <specPath> | <projectRoot>]");
    System.out.println("  bin/spark-sdp.sh dry-run [--spec <specPath> | <projectRoot>]");
    System.out.println("  bin/spark-sdp.sh help");
    System.out.println();
    System.out.println("Examples:");
    System.out.println("  bin/spark-sdp.sh dry-run --spec examples/sql-batch-pipeline/spark-pipeline.properties");
    System.out.println("  bin/spark-sdp.sh --master yarn --deploy-mode client run --spec examples/sql-batch-pipeline/spark-pipeline.properties");
    System.out.println("  bin/spark-sdp.sh run examples/sql-batch-pipeline");
    System.out.println();
    System.out.println("Direct jar compatibility:");
    System.out.println("  java -jar spark-sdp.sh-1.0.jar help");
    System.out.println();
    System.out.println("Packaged dry-run:");
    System.out.println("  ${SPARK_HOME}/bin/spark-submit --class com.bocom.rdss.spark.sdp3x.sql.SqlPipelineCliMain spark-sdp.sh-1.0.jar dry-run --spec examples/sql-batch-pipeline/spark-pipeline.properties");
    System.out.println();
